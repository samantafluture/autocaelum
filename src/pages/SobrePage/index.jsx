...
import img1 from '../../assets/images/foto-concessionaria.jpg';
      ...
      <MasterLayoyt>
        <main class="container">
          ...
          <figure class="foto-concessionaria">
            <img
              src={img1}
              alt="Foto do pátio da concessionária"
            />
            <figcaption>Pátio da concessionária</figcaption>
          </figure>
          <p>
          ...
          <p>
            Totam facilis illo est magni quos. Nostrum maxime, porro
            perspiciatis possimus, fugit in molestiae pariatur aliquam minus
            dicta et, tempora nesciunt? Fugiat blanditiis doloremque quam eum
            eligendi earum laudantium consectetur.
          </p>
          <p>
            Eaque hic velit ut cupiditate, laudantium, consequatur reiciendis
            fugit quisquam beatae reprehenderit dolorum. Quidem laborum facere
            est animi, vitae quo illo pariatur, nesciunt nulla nemo eaque atque
            molestias distinctio impedit.
          </p>
          <p>
            Suscipit enim odio nesciunt sint, atque, rem, quam nostrum unde
            distinctio cupiditate iusto labore? Laborum ea, sint numquam eum
            cupiditate dolores tempore. Suscipit blanditiis eveniet error. Enim
            eum architecto assumenda!
          </p>
          <p>
            Perferendis doloremque reprehenderit laboriosam rerum voluptas
            distinctio officia ea, ab facere, modi esse! Fugiat eaque maiores,
            neque impedit possimus nihil iure doloribus explicabo ipsam fuga
            omnis alias reprehenderit eveniet quis.
          </p>
          <p>
            Totam vel repellendus laudantium quibusdam aliquam consequatur quam
            molestiae qui deleniti harum cumque odit enim, quod quidem corrupti,
            exercitationem, esse beatae eaque obcaecati facere praesentium
            reiciendis. Nisi maxime impedit facere?
          </p>
          <p>
            Atque, officiis. Saepe ex nemo at quasi consequuntur minus delectus
            cumque? Quisquam, nesciunt neque quasi dolore similique itaque,
            molestiae alias harum doloribus, ad velit ipsum magni illum sint
            repellendus ducimus.
          </p>
          <p>
            Nisi dignissimos omnis possimus id aspernatur neque repellat odit
            explicabo nesciunt, officiis necessitatibus itaque, quisquam vitae
            a, reiciendis maxime architecto molestiae voluptatum? Omnis
            perferendis vel quae neque vitae quisquam. Suscipit!
          </p>
        </main>
      </MasterLayoyt>
    </>
